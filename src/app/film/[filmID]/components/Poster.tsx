        ...
        <div className='mx-[300px] '>
          ...
          <div className='py-4 w-full mt-4 border-b border-gray-200 pb-[50px]'>
            ...
            <div className='relative mt-3'>
              ...
              {/* comment */}
              <div className='whitespace-pre-wrap break-words text-md leading-relaxed text-gray-900'>
                Đúng là tôi đã mong đợi rất nhiều về bộ phim này, nhưng cuối
                cùng, nó thực sự làm tôi thất vọng. Tôi cảm thấy kịch bản không
                được viết tốt, những tình tiết trong phim thường làm mất đi sự
                logic và hợp lý. Diễn viên cũng không thể hiện tốt vai diễn của
                mình, và hình ảnh và âm nhạc cũng không ấn tượng. Tôi cảm thấy
                hỏng tiền vé khi xem bộ phim này và không khuyến khích ai khác
                xem.
              </div>
              {/* useful */}
              <div className='mt-4 flex items-center space-x-5 text-sm'>
