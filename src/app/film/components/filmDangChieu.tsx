...
export default function FilmDangChieu() {
  return (
    <div className=''>
      <section className="scroll-margin-top bg-[url('https://homepage.momocdn.net/img/momo-upload-api-210701105436-637607336767432408.jpg')] bg-black bg-contain bg-bottom bg-no-repeat py-8 md:py-10 lg:py-14 relative ">
